...
/**
 * The InventoryPage class represents the inventory page of the application.
 * It extends the {@link BasePage} class and provides methods to interact with the inventory page elements.
 */
public class InventoryPage extends BasePage {
     ...
     * <p>
     * The keyword "inventory" is specified in the JSON configuration file (config.json):
     * <pre>
     * {
     *   "pages": {
    ...
    /**
     * Checks if the inventory page is displayed by verifying the presence of the inventory list element.
     *
